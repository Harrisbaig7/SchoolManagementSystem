...
firstw=Tk()
firstw.title("SEMESTER PROJECT")
firstw.geometry("1600x1000+0+0")
label=Label(text="SIMPLE SCHOOL MANAGEMENT SYSTEM IN PYTHON",font=("times new roman",35),bg="#32a852",fg="#17161c")
label.pack(side=TOP ,fill=X)
user1=Label(text="USERNAME",font=("arial",23),fg="#f74d0a",bg="black")
user1.place(x=610,y=120)
user=Entry(width=17,bd=5,font=("arial",20))
user.place(x=570,y=200)
label.pack(side=TOP ,fill=X)
user2=Label(text="PASSWORD",font=("arial",23),fg="#f74d0a",bg="black")
user2.place(x=610,y=280)
user3=Entry(width=17,show="*",bd=5,font=("arial",20))
user3.place(x=570,y=360)
firstw.configure(background="black")

def second():
    global secondw
    secondw=Tk()
    secondw.title("SEMESTER PROJECT")
    secondw.geometry("1600x1000+0+0")
    secondw.configure(background="black")
    def distroy4():
        secondw.destroy()
        root()
    def student():
        student1=Tk()
        student1.title("ATTENDANCE")
    def studentid():
        rot = Tk()
        rot.title("SEMESTER PROJECT")
        rot.geometry("2000x1000+0+0")
        mainlabel = Label(rot, text="ATTENDANCE", font=("times new roman", 35), bg="#32a852",fg="#2f373d")
        mainlabel.pack(side=TOP, fill=X)
        chat1 = ttk.Treeview(rot,height=20, columns=('ROLL NUMBER','NAME','PRESENTS','ABSENTS'), selectmode="extended")
        chat1.heading('#0', text='ROLL NUMBER', anchor=CENTER)
        chat1.heading('#1', text='NAME', anchor=CENTER)
        chat1.heading('#2', text='DATE', anchor=CENTER)
        chat1.heading('#3', text="PRESENTS", anchor=CENTER)
        chat1.heading('#4', text="ABSENTS", anchor=CENTER)
        ...
        chat1.place(x=450, y=150)
        ttk.Style().configure("Treeview", background="blue", foreground="Green")
        ttk.Style().configure("Treeview.Heading", background="blue", foreground="Green")
        rot.configure(background='black')

        vsb=ttk.Scrollbar(rot, orient="vertical",command=chat1.yview)
        vsb.place(x=960,y=150,height=400+20)
    ...
    def viewquery2():
        rt = Tk()
        rt.title("SEMESTER PROJECT")
        rt.geometry("1600x1000+0+0")
        mainlabel =Label(rt, text="VISITOR", font=("times new roman", 35), bg="#32a852",fg="black")
        mainlabel.pack(side=TOP, fill=X)
        chat1 = ttk.Treeview(rt,height=20 , columns=('EMAIL', 'QUERY', 'DATE'), selectmode="extended")
        chat1.heading('#0', text='NAME', anchor=CENTER)
        chat1.heading('#1', text='EMAIL', anchor=CENTER)
        chat1.heading('#2', text='QUERY', anchor=CENTER)
        ...
        ttk.Style().configure("Treeview", background="black", foreground="Green")
        ttk.Style().configure("Treeview.heading", background="black", foreground="Green")
    ...
    def distroy5():
        secondw.destroy()
        window()
    mainlabel= Label(secondw,text="SCHOOL MANAGEMENT SYSTEM IN PYTHON", font=("times new roman", 35), bg="#32a852",fg="black")
    mainlabel.pack(side=TOP, fill=X)
    button = Button(secondw,width=15, font=("arial", 20), text="ENROLLMENT", bg="#5c5855",fg="#f74d0a", command=distroy4)
    button.place(x=10, y=480)
    query = Button(secondw, width=15, font=("arial", 20), text="FEE DETAILS", bg="#5c5855",fg="#f74d0a",command=distroy5)
    query.place(x=280, y=480)
    fee_details = Button(secondw, width=15, font=("arial", 20), text="QUERY", bg="#5c5855",fg="#f74d0a",command=query1)
    fee_details.place(x=560, y=480)
    viewquery= Button(secondw, width=15, font=("arial", 20), text="VIEW QUERY", bg="#5c5855",fg="#f74d0a",command=viewquery2)
    viewquery.place(x=840, y=480)
    viewquery1 = Button(secondw, width=15, font=("arial", 20), text="ATTENDANCE", bg="#5c5855",fg="#f74d0a",command=studentid)
    viewquery1.place(x=1100, y=480)
   
def file():
        root.filename=filedialog.askopenfile(initialdir="/",title="select file",filetypes=(("jpeg files","*.jpg"),("all files","*.*")))
        print(root.filename)
        os.chdir('C:\\')
        shutil.move((root.filename),("C:\\Users\\Haris\\Searches\\Pictures"))
...
def root():
    ...
    calculation2 = 2000
    label=Label(root,text="REGISTRATION FORM", font=("arial",25), bg="#32a852",fg="black")
    label.pack(side=TOP, fill=X)

    label1 =Label(root,text="NAME:", font=("arial",17),fg="#f74d0a")
    label1.place(x=300, y=150)

    label2=Label(root,text="SURNAME:", font=("arial",17),fg="#f74d0a")
    label2.place(x=300, y=210)

    label3=Label(root,text="EMAIL:", font=("arial",17),fg="#f74d0a")
    label3.place(x=300, y=270)

    label3=Label(root,text="GENDER:", font=("arial",17),fg="#f74d0a")
    label3.place(x=300, y=330)

    label4=Label(root,text="COURSE:", font=("arial",17),fg="#f74d0a")
    label4.place(x=300, y=390)

    label4=Label(root,text="BRANCH", font=("arial",17),fg="#f74d0a")
    label4.place(x=300, y=450)

    label4=Label(root,text="TOTAL FEE", font=("arial",17),fg="#f74d0a")
...
#================================radio buttton=======================================
    ...
    radio1=Radiobutton(root,text="MALE", variable=gander, value=1 ,font=("arial",13),fg="#f74d0a")
    radio1.place(x=515, y=340)

    radio2=Radiobutton(root,text="FEMALE", variable=gander, padx=20, value=0 ,font=("arial",13),fg="#f74d0a")
...
#===============================checkbutton====================================
    ...
    checkbutton1=Checkbutton(root,text="JAVA",variable=java,fg="#f74d0a")
    checkbutton1.place(x=502,y=455 )

    checkbutton1=Checkbutton(root,text="C",variable=c,fg="#f74d0a")
    checkbutton1.place(x=555,y=455 )

    checkbutton1=Checkbutton(root,text="C++",variable=d,fg="#f74d0a")
    checkbutton1.place(x=600,y=455 ,)
	 	 
    checkbutton1=Checkbutton(root,text="PYTHON",variable=python,fg="#f74d0a")
...
#=========================buttton==========================
    ...
    button1=Button(root,text="CALCULATE FEE",width=14,font=("arial",10),bg="black",fg="#f74d0a" ,command=calculation)
    ...
    button2=Button(root,text="SUBMIT FORM",width=14,font=("arial",10),bg="red",fg="black",command= msg  )
    button2.place(x=660 , y=630)

    button3=Button(root,text="RESET",width=14,font=("arial",10),bg="red",fg="black",command= golu )
    button3.place(x=395 , y=630)

    button4=Button(root,text="SEARCH",width=14,font=("arial",10),bg="red",fg="black",command=all )
    button4.place(x=1100 , y=150)
    
    button7 = Button(root, text="UPLOAD PHOTO", width=14, font=("arial", 10), bg="black", fg="#f74d0a",command=file)
    button7.place(x=1100, y=210)

    button4=Button(root,text="UPDATE",width=14,font=("arial",10),bg="red",fg="black" ,command=update)
    button4.place(x=950 , y=630)

    button5=Button(root,text="DELETE",width=14,font=("arial",10),bg="red",fg="black",command=delete )
    button5.place(x=800 , y=630)

    button6=Button(root,text="QUERY",width=14,font=("arial",10),bg="red", fg="black",command=window )
    button6.place(x=250 , y=630)
...
def ka():
    ...
    with conn:
        cur=conn.cursor()
        cur.execute('INSERT INTO golu(NAME,PHONE,PURPOSE,DATE)VALUES(?,?,?,?)',(NAME,PHONE,PURPOSE,today,))
        conn.commit()
def r():
    j()
    ka()
...
def query1():
    query1=Tk()
    query1.title("SEMESTER PROJECT")
    query1.geometry("1600x1000+0+0")
    query1.configure(background="black")
    purpose=StringVar()
    global entry23
    global entry24
    global box2
    def query1destroy():
        query1.destroy()
        second()
    label22 = Label(query1, text="QUERY", font=("arial", 25), bg="#32a852",fg="black")
    label22.pack(side=TOP, fill=X)
    label1 = Label(query1, text="NAME:", font=("arial", 17),fg="#f74d0a")
    label1.place(x=300, y=150)

    label2 = Label(query1, text="PHONE NO.:", font=("arial", 17),fg="#f74d0a")
    label2.place(x=300, y=210)

    label3 = Label(query1, text="PURPOSE:", font=("arial", 17),fg="#f74d0a")
    label3.place(x=300, y=270)
    entry23 = Entry(query1, bd=5, width=20, font=("arial", 15),fg="#f74d0a")
    entry23.place(x=500, y=150)
    button = Button(query1, text="Submit", width=30, bg="black",fg="#f74d0a", command=r)
    button.place(x=500, y=320)
    button1=Button(query1, text="<< BACK", width=30, bg="red",fg="black",command=query1destroy)
    button1.place(x=0,y=0)
    entry24 = Entry(query1, bd=5, width=20, font=("arial", 15))
    entry24.place(x=500, y=210)
    box2 = ttk.Combobox(query1, textvariable=purpose, state="readonly", font=("arial", 12, "bold"), width=22)
...
def window():
  ...
  label3=Label(main,text="ENTER STUDENT ID", font=("arial",17),bg="black",fg="#f74d0a")
  label3.place(x=400, y=100)
  label3 = Label(main, text="ENTER AMOUNT", font=("arial", 17),bg="black",fg="#f74d0a")
  label3.place(x=650, y=100)
  button22=Button(main,text="LOGIN",width=26,font=("arial",10),bg="black",fg="#f74d0a",command=cat )
  button22.place(x=400, y=310)
  button23=Button(main,text="ADD FEE",width=26,font=("arial",10),bg="black",fg="#f74d0a",command=installment2 )
  ...
  label31=Label(main,text="TOTAL FEE", font=("arial",17),bg="black",fg="#f74d0a")
  label31.place(x=900, y=550)
  label32=Label(main,text="PAID FEE", font=("arial",17),bg="black",fg="#f74d0a")
  label32.place(x=600, y=550)
  label33=Label(main,text="REMAINING FEE", font=("arial",17),bg="black",fg="#f74d0a")
...
def msg():
 if branch.get()=="SELECT" or  gander.get()==3 or  ( python.get()==0 and  java.get==0 and c.get()==0 and d.get()==0):
      calculate.set("PLEASE FILL ALL THE REQUIREMENTS")
 if  "@" and ".com" not in entry3.get() :
     kal=tkinter.messagebox.showinfo(" INVALID EMAIL","ENTER VALID EMAIL ADDRESS")
     entry3.delete(0,END)
 else:
...
QUERY=Button(text="LOGIN",width=17,font=("arial",20),bg="#5c5855",fg="#e66909",command=login )
QUERY.place(x=560 , y=480)
